...
public class TaiKhoanCaNhan {
    private int id;
    private String hoTen;

    public TaiKhoanCaNhan(int id, String hoTen, String bietDanh, Date ngaySinh, String faceboook, String instagram, String zalo, String gmail, byte[] avt) {
        this.id = id;
        this.hoTen = hoTen;
